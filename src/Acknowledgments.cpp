...
Acknowledgments::Acknowledgments()
    : mLibrariesCodeBrowser("Acknowledgments", SourceParse::acknowldegmentLibraries(), "")
{
}
...
void Acknowledgments::guiHelp()
{
    ...
    if (showHelp)
    {
        std::string help = "This application uses some great libraries, which are shown below.";
