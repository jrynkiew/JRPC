...
void WindowWithEditor::guiIconBar(VoidFunction additionalGui)
{
    ...
    /*if (ImGuiExt::SmallButton_WithEnabledFlag(ICON_FA_SAVE, true, "Save", true))
    {
        std::string fileSrc = "assets/shaders/qjVert.glsl";
        fplus::write_text_file(fileSrc, editor.GetText())();
        ImGui::BeginPopup("test"); // Tis doesn't work for some reason
    }*/
