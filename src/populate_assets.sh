...
cp -f $EXTERNAL_DIR/ImGuiColorTextEdit/README.md .
cp -f $EXTERNAL_DIR/ImGuiColorTextEdit/LICENSE .
cp -f $EXTERNAL_DIR/ImGuiColorTextEdit/CONTRIBUTING .
cd ..
...
cd imgui_markdown
cp -f $EXTERNAL_DIR/imgui_markdown/License.txt .
cp -f $EXTERNAL_DIR/imgui_markdown/README.md .
cd ..
